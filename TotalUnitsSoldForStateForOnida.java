...
public class TotalUnitsSoldForStateForOnida {
	public static void main(String[] args) throws Exception {
		Configuration c = new Configuration();

		Job totalUnitsSoldJob = new Job(c, "TotalUnitsSoldForStateForOnida");
		totalUnitsSoldJob.setJarByClass(TotalUnitsSoldForStateForOnida.class);
		totalUnitsSoldJob.setMapperClass(MapperTotalUnitsSoldForStateForOnida.class);
		totalUnitsSoldJob.setReducerClass(ReducerTotalUnitsSoldForStateForOnida.class);
